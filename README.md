...
Poor accountability and delayed responses from authorities

As a result, many civic problems remain unresolved, impacting the quality of urban life.
...
📍 Geotagging using GPS/location selection
...
🚦 Issue prioritization based on severity, location, and volume
